                  ...
                  <div className="flex items-start justify-between gap-4 mb-3">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="grid grid-cols-5 gap-3">
                        {/* Left column - Address (takes 3 columns) */}
                        <div className="flex items-start gap-2 text-gray-300 text-sm col-span-3">
                          <Icons.MapPin />
                          <p className="leading-snug text-xs">{jobData.job.job_address}</p>
                        </div>
                        
                        {/* Right column - Email and Phone stacked (takes 2 columns) */}
                        <div className="flex flex-col gap-1.5 col-span-2">
                          {jobData.contact?.email && (
                            <div className="flex items-center gap-1.5 text-gray-300 text-sm">
                              ...
                              <p className="truncate text-xs leading-tight">{jobData.contact.email}</p>
                            </div>
                          )}
                          {(jobData.contact?.mobile || jobData.contact?.phone) && (
                            <div className="flex items-center gap-1.5 text-gray-300 text-sm">
                              ...
                              <p className="text-xs leading-tight">{jobData.contact.mobile || jobData.contact.phone}</p>
                            </div>
                          )}
                        </div>
                      </div>
